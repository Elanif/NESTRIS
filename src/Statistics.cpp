...
void Statistics::renderBlocks() {
    ...
    const nes_uchar c0=ntris::block_colors[levelmod10][0];
    const nes_uchar c1=ntris::block_colors[levelmod10][1];
    const nes_uchar c2=ntris::block_colors[levelmod10][2];
    const nes_uchar c3=ntris::block_colors[levelmod10][3];
