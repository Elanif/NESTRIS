...
//todo manage priorities
    ...
    else if (_input.getPress(ntris::B)) {
        exit_menu = true;
    }
...
bool RenderLevelSelect::exitMenu() {
    if (exit_menu) {
        exit_menu = false;
        return true;
    }
...
void RenderLevelSelect::renderLevelSelect(const bool& _reload, GameplayContainer& _gameplay_container) {
...
void RenderLevelSelect::reload() {
    ...
    tilecont->at(24,17)=tiletype(32,0x0d,0x30,0x00,0x00);
    tilecont->at(10,17)=tiletype(24,0x0d,0x30,0x00,0x00);
    tilecont->at(12,17)=tiletype(23,0x0d,0x30,0x00,0x00);
    tilecont->at(11,17)=tiletype(11,0x0d,0x30,0x00,0x00);
    tilecont->at(13,17)=tilecont->at(20,17)=tiletype(15,0x0d,0x30,0x00,0x00);
    tilecont->at(23,17)=tiletype(22,0x0d,0x30,0x00,0x00);
    */
    ...
    tilecont->at(11,7)=tiletype(32,0x0d,0x30,0x00,0x00);
    ...
    tilecont->at(18,2)=tilecont->at(10,7)=tilecont->at(12,7)=tiletype(15,0x0d,0x30,0x00,0x00);
    ...
    tilecont->at(13,2)=tiletype(11,0x0d,0x30,0x00,0x00);
    ...
    tilecont->at(9,7)=tilecont->at(13,7)=tiletype(22,0x0d,0x30,0x00,0x00);
